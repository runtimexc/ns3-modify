...
#ifndef MP_RDMA_L4_PROTOCOL_H
#define MP_RDMA_L4_PROTOCOL_H
...
class MpRDMAL4Protocol : public IpL4Protocol {
public:
  /**
   ...
   */
  void SendPacket (Ptr<Packet> pkt, const MpRDMAHeader &outgoing,
   ...
   */
  void AddSocket (Ptr<MpRDMASocketImpl> socket);
   ...
   */
  bool RemoveSocket (Ptr<MpRDMASocketImpl> socket);
...
protected:
  ...
  PacketReceived (Ptr<Packet> packet, MpRDMAHeader &incomingMpRDMAHeader, 
   ...
   *
   */
  void NoEndPointsFound (const MpRDMAHeader &incomingHeader, const Address &incomingSAddr,
...
private:
  ...
  std::vector<Ptr<MpRDMASocketImpl> > m_sockets;      //!< list of sockets
   ...
   */
  MpRDMAL4Protocol (const MpRDMAL4Protocol &);
  /**
   * \brief Copy constructor
   *
   * Defined and not implemented to avoid misuse
   * \returns
   */
  MpRDMAL4Protocol &operator = (const MpRDMAL4Protocol &);
   ...
   * \param oif The output interface bound. Defaults to null (unspecified).
   */
  void SendPacketV4 (Ptr<Packet> pkt, const MpRDMAHeader &outgoing,
   ...
   * \param oif The output interface bound. Defaults to null (unspecified).
   */
  void SendPacketV6 (Ptr<Packet> pkt, const MpRDMAHeader &outgoing,
